<?php
class Zend_View_Helper_GenerateMeta_Restaurant_Vacancy
    extends
        Zend_View_Helper_Abstract {

    public function GenerateMeta_Restaurant_Vacancy(
        Application_Model_City $city,
        Application_Model_Restaurant $restaurant
    ) {
        $this->view->headTitle( join(' ', array(
            $this->view->translate->_('Вакансии ресторана ') . $restaurant->getName() . '.',
